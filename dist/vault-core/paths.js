 ...
 */
export function autoResolveVaultDir() {
    if (process.env.KEY_VAULT_DIR)
        return process.env.KEY_VAULT_DIR;
    const ffclawDir = globalVaultDir();
    if (fs.existsSync(storePath(ffclawDir)))
        return ffclawDir;
